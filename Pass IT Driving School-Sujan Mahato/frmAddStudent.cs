...
namespace WinFormsApp6
{
    public partial class frmAddStudent : Form
    {
        ...
        public void frmAddStudent_Load(object sender, EventArgs e)
        {
            ...
            newItem2.SubItems.Add("Khadka");
            newItem2.SubItems.Add("Male");
            newItem2.SubItems.Add("0467876");
            newItem2.SubItems.Add("West Brom,Birmingham");
            newItem2.SubItems.Add("tri00@gmail.com");
        ...
        private void btnBooking_Click(object sender, EventArgs e)
        {
            if (txtFname.Text != "" && txtLname.Text != "")
            {
                ...
                booking.Show();
                frmBooking.booking.studentFname.Text = txtFname.Text;
                frmBooking.booking.studentLname.Text = txtLname.Text;
            }
            else
            {
                MessageBox.Show("No Student Recrod Selected!!!");
            }
        }
